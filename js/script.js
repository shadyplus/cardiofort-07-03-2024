...
const massange = [{
    m: "مرحبا! اسمي عبد الله. أنا أخصائي أمراض قلبية بخبرة تزيد عن 28 عامًا."
}, {
    m: "أقدم هنا تشخيصًا عبر الإنترنت مجانًا وتوصيات شخصية لسكان صربيا لمساعدتهم على التخلص من أمراض القلب وعواقبها نهائيًا."
}, {
    ...
    m: '<p class="quest">كم تزن؟</p>'
}, {
    m: "<p class='quest'>هل تشعر بألم في القلب، تغيرات في الضغط، دوار، غثيان؟</p>"
}, {
    m: '<p class="quest">هل نمط حياتك مليء بالتوتر؟</p>'
}, {
    m: '<p class="quest">هل كان لدى أقاربك أزمة قلبية؟</p>'
}, {
    m: '<p class="quest">كيف تتغذى؟</p>'
}, {
    m: '<p class="quest">ما هو ضغط دمك الطبيعي؟</p>'
}, {
    m: "نعم، للأسف، لديك علامات تطور أزمة ارتفاع ضغط الدم، السكتة الدماغية وتكوين الجلطات. الانسداد الحاد للأوعية الدموية وقفزات الضغط تؤدي إلى الإعاقة والموت."
}, {
    ...
    m: "<b>التوصية الشخصية لك:</b> تناول مستخلص القرفة، مستخلص الثوم الأبيض، والبيوفلافونويد."
}, {
    m: "<i>مستخلص القرفة</i> يتمتع بتأثيرات واقية للقلب بفضل خصائصه المضادة للالتهابات وقدرته على تكوين أكسيد النيتريك، المركب الذي يسبب استرخاء الشرايين ويسهل تدفق الدم."
}, {
    m: "<i>مستخلص الثوم الأبيض</i> يقلل من مستويات الكوليسترول 'السيئ'، يخفض ضغط الدم ويحسن مرونة الأوعية الدموية."
}, {
    m: "<i>البيوفلافونويد</i> يخفف من ارتفاع ضغط الدم، يحسن تدفق الدم الوريدي، يزيل الجلطات الدموية ويعزز صحة عضلة القلب."
}, {
    m: "يمكن تناول كل من هذه المكونات على حدة، لكنها أكثر فعالية لارتفاع ضغط الدم عند استخدامها مجتمعة. لذلك، تحتوي كبسولات Cardiofort على جميع المكونات المذكورة بالإضافة إلى فيتامينات ومعادن إضافية."
}, {
    m: "هكذا يبدو Cardiofort: <img src='img/prod.png' />"
}, {
    m: "كبسولات Cardiofort تساعد في مكافحة الصداع، البقع أمام العينين، الغثيان، والدوار من اليوم الأول للاستخدام."
}, {
    m: "المنتج يعمل في الجسم في عدة اتجاهات في آن واحد: يخفف الدم ويحسن الدورة الدموية، يساعد على التخلص من كميات كبيرة من الملح بطريقة طبيعية - من خلال البول."
}, {
    ...
    m: "<b>فقط دورة واحدة من كبسولات Cardiofort، وهذه هي النتائج التي حققها مرضاي:</b> <img src='img/image7.jpg' /> <img src='img/image6.jpg' /> <img src='img/image3.jpg' />"
}, {
    ...
    m: "Cardiofort يطبع ضغط الدم، يسرع الدورة الدموية ويتيح لك التخلص من الجلطات الدموية، مدد العمر لما لا يقل عن 20 عامًا!"
}, {
    m: "المدة الأمثل للعلاج، مع مراعاة عمرك وجميع الخصائص الجديدة، هي شهر واحد. يجب تناول الكبسولات مرة واحدة يوميًا دون تخطي."
}, {
    m: "لدي أيضًا أخبار رائعة لك. لقد أصبحت المشارك رقم 1000 في التشخيص الأونلاين لارتفاع ضغط الدم في صربيا! تهانينا!"
}, {
    m: "يمكنك شراء كبسولات Cardiofort بسعر ترويجي مع خصم بنسبة " + discount + "%. للقيام بذلك، يرجى ملء النموذج أدناه."
}];
